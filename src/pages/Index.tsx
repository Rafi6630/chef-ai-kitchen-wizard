...
export default function Index() {
  ...
  const handleAddIngredients = (ingredients: string[]) => {
    ...
    // Move to the confirm ingredients step
    setStep("confirm");
  };
  
  const findRecipes = () => {
    // Navigate to browse page with filters
    navigate(`/browse?category=${selectedCategory}&subcategory=${selectedSubcategory}&cuisine=${selectedCuisine || 'all'}&ingredients=${selectedIngredients.join(',')}`);
  };
