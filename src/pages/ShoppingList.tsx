...
export default function ShoppingList() {
  ...
  return (
    <AppLayout>
      ...
      <PremiumFeatureGate feature="shoppingList" featureDisplay="shopping list">
        <main className="p-6">
          ...
          {showAddForm && (
            <div className="bg-white rounded-xl p-4 mb-6 border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                  ...
                  {categoryItems.map(item => (
                    <li 
                      ...
                      className={`flex items-center p-3 border rounded-lg ${
                        item.isChecked ? 'bg-gray-50 border-gray-200 dark:bg-gray-700' : 'bg-white border-gray-200 dark:bg-gray-800 dark:border-gray-700'
                      }`}
